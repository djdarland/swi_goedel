:- module(sharedPrograms,[]).  %% converted djd
%% :- module('SharedPrograms', []).

:- discontiguous 'sharedPrograms.ChainExprToIntDL.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.ChainExprToIntDL.P6'/6. %% added djd
:- discontiguous 'sharedPrograms.AddOtherModulesAux.P7'/7. %% added djd
:- discontiguous '~sharedPrograms.AddOtherModulesAux.P7'/7. %% added djd
:- discontiguous 'sharedPrograms.AddImportToPart.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.AddImportToPart.P6'/6. %% added djd
:- discontiguous 'sharedPrograms.Accessible.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.Accessible.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.AddLiftedLanguage.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.AddLiftedLanguage.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.BinaryConnective.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.BinaryConnective.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.AtomToIntDL.P8'/8. %% added djd
:- discontiguous '~sharedPrograms.AtomToIntDL.P8'/8. %% added djd
:- discontiguous 'sharedPrograms.BinConnectiveChars.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.BinConnectiveChars.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.CLPrec.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.CLPrec.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.BindsTighter.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.BindsTighter.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.CRPrec.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.CRPrec.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.CheckHeadArgs1.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.CheckHeadArgs1.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.CheckHeadArgs.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.CheckHeadArgs.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.ContainsConditional.P1'/1. %% added djd
:- discontiguous '~sharedPrograms.ContainsConditional.P1'/1. %% added djd
:- discontiguous 'sharedPrograms.DivideBindings.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.DivideBindings.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.DeleteUnderscores.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.DeleteUnderscores.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.DivideBindingsAux.P5'/5. %% added djd
:- discontiguous '~sharedPrograms.DivideBindingsAux.P5'/5. %% added djd
:- discontiguous 'sharedPrograms.ExpandStringAux.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.ExpandStringAux.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.FixVariableTyping.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.FixVariableTyping.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.FormulaToIntDL.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.FormulaToIntDL.P6'/6. %% added djd
:- discontiguous 'sharedPrograms.ImportedLanguage.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.ImportedLanguage.P6'/6. %% added djd
:- discontiguous 'sharedPrograms.HeadAtom.P9'/9. %% added djd
:- discontiguous '~sharedPrograms.HeadAtom.P9'/9. %% added djd
:- discontiguous 'sharedPrograms.KindHasPart.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.KindHasPart.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.IsVariable.P1'/1. %% added djd
:- discontiguous '~sharedPrograms.IsVariable.P1'/1. %% added djd
:- discontiguous 'sharedPrograms.LPrec.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.LPrec.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.ListTypesInLanguage.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.ListTypesInLanguage.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.LookupParDictAux.P5'/5. %% added djd
:- discontiguous '~sharedPrograms.LookupParDictAux.P5'/5. %% added djd
:- discontiguous 'sharedPrograms.LookupVarTypingAux.P5'/5. %% added djd
:- discontiguous '~sharedPrograms.LookupVarTypingAux.P5'/5. %% added djd
:- discontiguous 'sharedPrograms.MeltVariableTyping.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.MeltVariableTyping.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.MeltType.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.MeltType.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.MatchingName.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.MatchingName.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.MeltTypeList.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.MeltTypeList.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.MeltedAtomTyping.P8'/8. %% added djd
:- discontiguous '~sharedPrograms.MeltedAtomTyping.P8'/8. %% added djd
:- discontiguous 'sharedPrograms.MeltedArgumentTyping.P9'/9. %% added djd
:- discontiguous '~sharedPrograms.MeltedArgumentTyping.P9'/9. %% added djd
:- discontiguous 'sharedPrograms.MeltedTermType.P9'/9. %% added djd
:- discontiguous '~sharedPrograms.MeltedTermType.P9'/9. %% added djd
:- discontiguous 'sharedPrograms.MeltedStandardTyping.P8'/8. %% added djd
:- discontiguous '~sharedPrograms.MeltedStandardTyping.P8'/8. %% added djd
:- discontiguous 'sharedPrograms.OpenKind.P1'/1. %% added djd
:- discontiguous '~sharedPrograms.OpenKind.P1'/1. %% added djd
:- discontiguous 'sharedPrograms.MustBracketThen.P1'/1. %% added djd
:- discontiguous '~sharedPrograms.MustBracketThen.P1'/1. %% added djd
:- discontiguous 'sharedPrograms.QuantifiedFormula.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.QuantifiedFormula.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.RPrec.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.RPrec.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.QuantifierChars.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.QuantifierChars.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.ReformatDelays.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.ReformatDelays.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.RestVarListToIntDL.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.RestVarListToIntDL.P6'/6. %% added djd
:- discontiguous 'sharedPrograms.SimpleCondToIntDL.P3'/3. %% added djd
:- discontiguous '~sharedPrograms.SimpleCondToIntDL.P3'/3. %% added djd
:- discontiguous 'sharedPrograms.TypeInLanguage.P2'/2. %% added djd
:- discontiguous '~sharedPrograms.TypeInLanguage.P2'/2. %% added djd
:- discontiguous 'sharedPrograms.TermToIntDL.P9'/9. %% added djd
:- discontiguous '~sharedPrograms.TermToIntDL.P9'/9. %% added djd
:- discontiguous 'sharedPrograms.TermListToIntDLAux.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.TermListToIntDLAux.P6'/6. %% added djd
:- discontiguous 'sharedPrograms.TermToIntDLAux.P11'/11. %% added djd
:- discontiguous '~sharedPrograms.TermToIntDLAux.P11'/11. %% added djd
:- discontiguous 'sharedPrograms.TypeListToIntDLAux.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.TypeListToIntDLAux.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.TypeToIntDL.P4'/4. %% added djd
:- discontiguous '~sharedPrograms.TypeToIntDL.P4'/4. %% added djd
:- discontiguous 'sharedPrograms.UpdateDelays.P6'/6. %% added djd
:- discontiguous '~sharedPrograms.UpdateDelays.P6'/6. %% added djd
...
'~sharedPrograms.BinaryConnective.P3'('MetaDefs.&''.F2'(A,B), A, B).
'sharedPrograms.BinaryConnective.P3'('MetaDefs.\\/''.F2'(A,B), A, B). % added \ djd
'~sharedPrograms.BinaryConnective.P3'('MetaDefs.\\/''.F2'(A,B), A, B). % added \ djd
'sharedPrograms.BinaryConnective.P3'('MetaDefs.->''.F2'(A,B), A, B).
'~sharedPrograms.BinaryConnective.P3'('MetaDefs.->''.F2'(A,B), A, B).
'sharedPrograms.BinaryConnective.P3'('MetaDefs.<-''.F2'(A,B), A, B).
...
'~sharedPrograms.BinConnectiveChars.P3'('MetaDefs.&''.F2'(_,_), A, B) :-
        'Strings':'~Strings.StringInts.P2'('" & ', C),
        'Lists':'~Lists.Append.P3'(C, B, A).
'sharedPrograms.BinConnectiveChars.P3'('MetaDefs.\\/''.F2'(_,_), A, B) :- % added \ djd
        'Strings':'Strings.StringInts.P2'('" \\/ ', C), % added \ djd
        'Lists':'Lists.Append.P3'(C, B, A).
'~sharedPrograms.BinConnectiveChars.P3'('MetaDefs.\\/''.F2'(_,_), A, B) :- % added \ djd
        'Strings':'~Strings.StringInts.P2'('" \\/ ', C), % added \ djd
        'Lists':'~Lists.Append.P3'(C, B, A).
...
'~sharedPrograms.CLPrec.P2'('MetaDefs.&''.F2'(_,_), 'sharedPrograms.Prec.F2'(100,'sharedPrograms.X.C0')).
'sharedPrograms.CLPrec.P2'('MetaDefs.\\/''.F2'(_,_), 'sharedPrograms.Prec.F2'(90,'sharedPrograms.X.C0')). % added \ djd
'~sharedPrograms.CLPrec.P2'('MetaDefs.\\/''.F2'(_,_), 'sharedPrograms.Prec.F2'(90,'sharedPrograms.X.C0')).  % added \ djd
...
'~sharedPrograms.CRPrec.P2'('MetaDefs.&''.F2'(_,_), 'sharedPrograms.Prec.F2'(100,'sharedPrograms.Y.C0')).
'sharedPrograms.CRPrec.P2'('MetaDefs.\\/''.F2'(_,_), 'sharedPrograms.Prec.F2'(90,'sharedPrograms.Y.C0')).  % added \ djd
'~sharedPrograms.CRPrec.P2'('MetaDefs.\\/''.F2'(_,_), 'sharedPrograms.Prec.F2'(90,'sharedPrograms.Y.C0')).  % added \ djd
...
'sharedPrograms.ExpandStringAux.P3'([A|B], C, D) :-
        user:goedel_freeze(ground([A]), (A=34,true->'SharedPrograms':'sharedPrograms.CharDL.P3'('"\\',C,E),'SharedPrograms':'sharedPrograms.CharDL.P3'('""',E,F);user:goedel_freeze(ground([A]),(A=92,true->'SharedPrograms':'sharedPrograms.CharDL.P3'('"\\',C,E),'SharedPrograms':'sharedPrograms.CharDL.P3'('"\\',E,F);C=[A|F])))), %% added 3 \ djd
...
'~sharedPrograms.FormulaToIntDL.P6'('MetaDefs.&''.F2'(A,B), C, D, E, F, G) :-
        '~sharedPrograms.BinaryFormulaToIntDL.P6'('MetaDefs.&''.F2'(A,B), C, D, E, F, G).
'sharedPrograms.FormulaToIntDL.P6'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, G) :- % added \ djd
        'sharedPrograms.BinaryFormulaToIntDL.P6'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, G). % added \ djd
'~sharedPrograms.FormulaToIntDL.P6'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, G) :- % added \ djd
        '~sharedPrograms.BinaryFormulaToIntDL.P6'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, G). % added \ djd
'sharedPrograms.FormulaToIntDL.P6'('MetaDefs.->''.F2'(A,B), C, D, E, F, G) :-
        'sharedPrograms.BinaryFormulaToIntDL.P6'('MetaDefs.->''.F2'(A,B), C, D, E, F, G).
...
'~sharedPrograms.MeltedStandardTyping.P8'('MetaDefs.&''.F2'(A,B), C, D, E, 'MetaDefs.&''.F2'(F,G), H, I, J) :-
        '~sharedPrograms.MeltedStandardTyping.P8'(A, C, D, K, F, H, L, M),
        user:goedel_freeze(ground([M]), (M=[],true->'SharedPrograms':'~sharedPrograms.MeltedStandardTyping.P8'(B,C,K,E,G,L,I,J);J=M)).
'sharedPrograms.MeltedStandardTyping.P8'('MetaDefs.\\/''.F2'(A,B), C, D, E, 'MetaDefs.\\/''.F2'(F,G), H, I, J) :- % added 2 \ djd
        'sharedPrograms.MeltedStandardTyping.P8'(A, C, D, K, F, H, L, M),
        user:goedel_freeze(ground([M]), (M=[],true->'SharedPrograms':'sharedPrograms.MeltedStandardTyping.P8'(B,C,K,E,G,L,I,J);J=M)).
'~sharedPrograms.MeltedStandardTyping.P8'('MetaDefs.\\/''.F2'(A,B), C, D, E, 'MetaDefs.\\/''.F2'(F,G), H, I, J) :- % added 2 \ djd
        '~sharedPrograms.MeltedStandardTyping.P8'(A, C, D, K, F, H, L, M),
...
'sharedPrograms.OrSeqToIntDL.P3'('ProgDefs.Or.F2'(A,B), C, D) :-
        'sharedPrograms.SimpleCondToIntDL.P3'(A, C, E),
        'Strings':'Strings.StringInts.P2'('" \\/ ', F), % added \ djd
        'Lists':'Lists.Append.P3'(F, G, E),
