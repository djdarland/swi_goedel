:- module(formula,[atom/5,end_of_atom/1,create_formula/3,formula/3]).  % converted djd
...
connective('\\/', connective('MetaDefs.\\/''.F2', 'Syntax.XFY.F1'(140))). % added 2 \ djd
...
lookup_reserved_word('\\/',   % added \ djd
	connective('MetaDefs.\\/''.F2', 'Syntax.YFX.F1'(140))).  % added \ djd
lookup_reserved_word('->',
...
end_of_conditional_aux('|').
end_of_conditional_aux('\\/').   % added \ djd
end_of_conditional_aux('<-').
end_of_conditional_aux('->').
end_of_conditional_aux('<->').
