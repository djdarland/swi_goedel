:- module(Rationals,[]). % converted djd
...
:- discontiguous module/1.  %% added djd
%% '$$module'('@(#)Rationals.sup 1.8 last updated 93/12/08 16:19:16 by jiwei').
module(rationalssup). %% converted djd
:- discontiguous plus/3.     %% added djd
:- discontiguous negative/2.  %% added djd
:- discontiguous minus/3.     %% added djd
:- discontiguous times/3.     %% added djd
:- discontiguous divides/3.   %% added djd
:- discontiguous power/3.     %% added djd
:- discontiguous power2/4.    %% added djd
:- discontiguous absolute/2.  %% added djd
:- discontiguous sign/2.      %% added djd
:- discontiguous maximum/3.   %% added djd
:- discontiguous minimum/3.   %% added djd
