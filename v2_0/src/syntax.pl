:- module(syntax,[]).  %% convered djd
:- style_check(-singleton). % added djd
%% :- module('Syntax', []).

:- discontiguous 'Syntax.GroundType.P1.0'/1. %% added djd
:- discontiguous '~Syntax.GroundType.P1.0'/1. %% added djd
:- discontiguous 'Syntax.CommitFreeFormula.P1.0'/1. %% added djd
:- discontiguous '~Syntax.CommitFreeFormula.P1.0'/1. %% added djd
:- discontiguous 'Syntax.Atom.P1.0'/1. %% added djd
:- discontiguous '~Syntax.Atom.P1.0'/1. %% added djd
:- discontiguous 'Syntax.AppendTypeBindings.P3'/3. %% added djd
:- discontiguous '~Syntax.AppendTypeBindings.P3'/3. %% added djd
:- discontiguous 'Syntax.AppendTermBindings.P3'/3. %% added djd
:- discontiguous '~Syntax.AppendTermBindings.P3'/3. %% added djd
:- discontiguous 'Syntax.ApplySubstToTerm.P8'/8. %% added djd
:- discontiguous '~Syntax.ApplySubstToTerm.P8'/8. %% added djd
:- discontiguous 'Syntax.ApplySubstToFormula.P9'/9. %% added djd
:- discontiguous '~Syntax.ApplySubstToFormula.P9'/9. %% added djd
:- discontiguous 'Syntax.ApplySubstToFormula.P3.0'/3. %% added djd
:- discontiguous '~Syntax.ApplySubstToFormula.P3.0'/3. %% added djd
:- discontiguous 'Syntax.ApplySubstToArgs.P8'/8. %% added djd
:- discontiguous '~Syntax.ApplySubstToArgs.P8'/8. %% added djd
:- discontiguous 'Syntax.ApplySubstToVarTypes.P3'/3. %% added djd
:- discontiguous '~Syntax.ApplySubstToVarTypes.P3'/3. %% added djd
:- discontiguous 'Syntax.CheckVariantTerms1.P4'/4. %% added djd
:- discontiguous '~Syntax.CheckVariantTerms1.P4'/4. %% added djd
:- discontiguous 'Syntax.CheckVariantFormulas1.P4'/4. %% added djd
:- discontiguous '~Syntax.CheckVariantFormulas1.P4'/4. %% added djd
:- discontiguous 'Syntax.CheckFunctionTerm1.P10'/10. %% added djd
:- discontiguous '~Syntax.CheckFunctionTerm1.P10'/10. %% added djd
:- discontiguous 'Syntax.CheckFunctionTerm.P10'/10. %% added djd
:- discontiguous '~Syntax.CheckFunctionTerm.P10'/10. %% added djd
:- discontiguous 'Syntax.CheckVariantFormulas.P4'/4. %% added djd
:- discontiguous '~Syntax.CheckVariantFormulas.P4'/4. %% added djd
:- discontiguous 'Syntax.CheckVariantTerms.P4'/4. %% added djd
:- discontiguous '~Syntax.CheckVariantTerms.P4'/4. %% added djd
:- discontiguous 'Syntax.CombineVarTypings1.P6'/6. %% added djd
:- discontiguous '~Syntax.CombineVarTypings1.P6'/6. %% added djd
:- discontiguous 'Syntax.ConjunctionOfAtoms.P1.0'/1. %% added djd
:- discontiguous '~Syntax.ConjunctionOfAtoms.P1.0'/1. %% added djd
:- discontiguous 'Syntax.ConditionalFreeFormula.P1'/1. %% added djd
:- discontiguous '~Syntax.ConditionalFreeFormula.P1'/1. %% added djd
:- discontiguous 'Syntax.ConstantTerm.P2'/2. %% added djd
:- discontiguous '~Syntax.ConstantTerm.P2'/2. %% added djd
:- discontiguous 'Syntax.DefiniteBody.P1.0'/1. %% added djd
:- discontiguous '~Syntax.DefiniteBody.P1.0'/1. %% added djd
:- discontiguous 'Syntax.DefiniteStatement.P1.0'/1. %% added djd
:- discontiguous '~Syntax.DefiniteStatement.P1.0'/1. %% added djd
:- discontiguous 'Syntax.DeleteBindings.P3'/3. %% added djd
:- discontiguous '~Syntax.DeleteBindings.P3'/3. %% added djd
:- discontiguous 'Syntax.DeleteAllVars.P3'/3. %% added djd
:- discontiguous '~Syntax.DeleteAllVars.P3'/3. %% added djd
:- discontiguous 'Syntax.Derive.P7.0'/7. %% added djd
:- discontiguous '~Syntax.Derive.P7.0'/7. %% added djd
:- discontiguous 'Syntax.DeleteVarTypeBindings.P3'/3. %% added djd
:- discontiguous '~Syntax.DeleteVarTypeBindings.P3'/3. %% added djd
:- discontiguous 'Syntax.FindTypeBindings.P3'/3. %% added djd
:- discontiguous '~Syntax.FindTypeBindings.P3'/3. %% added djd
:- discontiguous 'Syntax.FindTermBindings.P3'/3. %% added djd
:- discontiguous '~Syntax.FindTermBindings.P3'/3. %% added djd
:- discontiguous 'Syntax.GroundAtom.P1.0'/1. %% added djd
:- discontiguous '~Syntax.GroundAtom.P1.0'/1. %% added djd
:- discontiguous 'Syntax.GroundTerm.P1.0'/1. %% added djd
:- discontiguous '~Syntax.GroundTerm.P1.0'/1. %% added djd
:- discontiguous 'Syntax.GroundTerm1.P1'/1. %% added djd
:- discontiguous '~Syntax.GroundTerm1.P1'/1. %% added djd
:- discontiguous 'Syntax.Parameter.P1.0'/1. %% added djd
:- discontiguous '~Syntax.Parameter.P1.0'/1. %% added djd
:- discontiguous 'Syntax.NormalBody.P1.0'/1. %% added djd
:- discontiguous '~Syntax.NormalBody.P1.0'/1. %% added djd
:- discontiguous 'Syntax.GroundType1.P1'/1. %% added djd
:- discontiguous '~Syntax.GroundType1.P1'/1. %% added djd
:- discontiguous 'Syntax.MaxParIndex.P3'/3. %% added djd
:- discontiguous '~Syntax.MaxParIndex.P3'/3. %% added djd
:- discontiguous 'Syntax.MaxParIndex1.P3'/3. %% added djd
:- discontiguous '~Syntax.MaxParIndex1.P3'/3. %% added djd
:- discontiguous 'Syntax.NonParameter.P1.0'/1. %% added djd
:- discontiguous '~Syntax.NonParameter.P1.0'/1. %% added djd
:- discontiguous 'Syntax.NonVariable.P1.0'/1. %% added djd
:- discontiguous '~Syntax.NonVariable.P1.0'/1. %% added djd
:- discontiguous 'Syntax.NormalStatement.P1.0'/1. %% added djd
:- discontiguous '~Syntax.NormalStatement.P1.0'/1. %% added djd
:- discontiguous 'Syntax.OpaqueTerm.P1.0'/1. %% added djd
:- discontiguous '~Syntax.OpaqueTerm.P1.0'/1. %% added djd
:- discontiguous 'Syntax.NotMember.P2'/2. %% added djd
:- discontiguous '~Syntax.NotMember.P2'/2. %% added djd
:- discontiguous 'Syntax.OpaqueAtom.P1.0'/1. %% added djd
:- discontiguous '~Syntax.OpaqueAtom.P1.0'/1. %% added djd
:- discontiguous 'Syntax.OpaqueType.P1.0'/1. %% added djd
:- discontiguous '~Syntax.OpaqueType.P1.0'/1. %% added djd
:- discontiguous 'Syntax.RenameAllTerm2.P4'/4. %% added djd
:- discontiguous '~Syntax.RenameAllTerm2.P4'/4. %% added djd
:- discontiguous 'Syntax.ParamsInType.P3'/3. %% added djd
:- discontiguous '~Syntax.ParamsInType.P3'/3. %% added djd
:- discontiguous 'Syntax.ParameterName.P3'/3. %% added djd
:- discontiguous '~Syntax.ParameterName.P3'/3. %% added djd
:- discontiguous 'Syntax.ParamsInType1.P3'/3. %% added djd
:- discontiguous '~Syntax.ParamsInType1.P3'/3. %% added djd
:- discontiguous 'Syntax.RenameAllFormula2.P4'/4. %% added djd
:- discontiguous '~Syntax.RenameAllFormula2.P4'/4. %% added djd
:- discontiguous 'Syntax.RenameAllFormula3.P6'/6. %% added djd
:- discontiguous '~Syntax.RenameAllFormula3.P6'/6. %% added djd
:- discontiguous 'Syntax.RenameAllType3.P6'/6. %% added djd
:- discontiguous '~Syntax.RenameAllType3.P6'/6. %% added djd
:- discontiguous 'Syntax.RenameAllTerm4.P6'/6. %% added djd
:- discontiguous '~Syntax.RenameAllTerm4.P6'/6. %% added djd
:- discontiguous 'Syntax.RenameAllTerm3.P6'/6. %% added djd
:- discontiguous '~Syntax.RenameAllTerm3.P6'/6. %% added djd
:- discontiguous 'Syntax.RenameAllType2.P4'/4. %% added djd
:- discontiguous '~Syntax.RenameAllType2.P4'/4. %% added djd
:- discontiguous 'Syntax.RenameAllType4.P6'/6. %% added djd
:- discontiguous '~Syntax.RenameAllType4.P6'/6. %% added djd
:- discontiguous 'Syntax.Resolve1.P9'/9. %% added djd
:- discontiguous '~Syntax.Resolve1.P9'/9. %% added djd
:- discontiguous 'Syntax.ResolveAll1.P10'/10. %% added djd
:- discontiguous '~Syntax.ResolveAll1.P10'/10. %% added djd
:- discontiguous 'Syntax.StandardiseApartQuants.P6'/6. %% added djd
:- discontiguous '~Syntax.StandardiseApartQuants.P6'/6. %% added djd
:- discontiguous 'Syntax.StandardiseCommits.P5'/5. %% added djd
:- discontiguous '~Syntax.StandardiseCommits.P5'/5. %% added djd
:- discontiguous 'Syntax.Statement.P1.0'/1. %% added djd
:- discontiguous '~Syntax.Statement.P1.0'/1. %% added djd
:- discontiguous 'Syntax.TypeNotOccur1.P2'/2. %% added djd
:- discontiguous '~Syntax.TypeNotOccur1.P2'/2. %% added djd
:- discontiguous 'Syntax.TypeNotOccur.P2'/2. %% added djd
:- discontiguous '~Syntax.TypeNotOccur.P2'/2. %% added djd
:- discontiguous 'Syntax.TypeOccurCheck.P3'/3. %% added djd
:- discontiguous '~Syntax.TypeOccurCheck.P3'/3. %% added djd
:- discontiguous 'Syntax.UnifyTerms.P13'/13. %% added djd
:- discontiguous '~Syntax.UnifyTerms.P13'/13. %% added djd
:- discontiguous 'Syntax.UnifyArgs.P11'/11. %% added djd
:- discontiguous '~Syntax.UnifyArgs.P11'/11. %% added djd
:- discontiguous 'Syntax.UnifyTypeArgs.P5'/5. %% added djd
:- discontiguous '~Syntax.UnifyTypeArgs.P5'/5. %% added djd
:- discontiguous 'Syntax.UnifyTypes1.P5'/5. %% added djd
:- discontiguous '~Syntax.UnifyTypes1.P5'/5. %% added djd
:- discontiguous 'Syntax.UnifyTypes0.P4'/4. %% added djd
:- discontiguous '~Syntax.UnifyTypes0.P4'/4. %% added djd
:- discontiguous 'Syntax.Variable.P1.0'/1. %% added djd
:- discontiguous '~Syntax.Variable.P1.0'/1. %% added djd
:- discontiguous 'Syntax.UnifyValue.P5'/5. %% added djd
:- discontiguous '~Syntax.UnifyValue.P5'/5. %% added djd
...
'~Syntax.CommitFreeFormula.P1.0'('MetaDefs.&''.F2'(A,B)) :-
        '~Syntax.CommitFreeFormula.P1'(A),
        '~Syntax.CommitFreeFormula.P1'(B).
'Syntax.CommitFreeFormula.P1.0'('MetaDefs.\\/''.F2'(A,B)) :-  % added \ djd
        'Syntax.CommitFreeFormula.P1'(A),
        'Syntax.CommitFreeFormula.P1'(B).
'~Syntax.CommitFreeFormula.P1.0'('MetaDefs.\\/''.F2'(A,B)) :-   % added \ djd
        '~Syntax.CommitFreeFormula.P1'(A),
...
'~Syntax.ApplySubstToFormula.P9'('MetaDefs.XPAtom.F1'(A), B, B, _, _, C, C, _, 'MetaDefs.XPAtom.F1'(A)).
'Syntax.ApplySubstToFormula.P9'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, G, H, I, 'MetaDefs.\\/''.F2'(J,K)) :-  % added 2 \ djd
        'Syntax.ApplySubstToFormula.P9'(A, C, L, E, F, G, M, I, J),
        'Syntax.ApplySubstToFormula.P9'(B, L, D, E, F, M, H, I, K).
'~Syntax.ApplySubstToFormula.P9'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, G, H, I, 'MetaDefs.\\/''.F2'(J,K)) :-   % added 2 \ djd
        '~Syntax.ApplySubstToFormula.P9'(A, C, L, E, F, G, M, I, J),
...
'~Syntax.ApplySubstToFormula.P3.0'('MetaDefs.&''.F2'(A,B), C, 'MetaDefs.&''.F2'(D,E)) :-
        '~Syntax.ApplySubstToFormula.P3'(A, C, D),
        '~Syntax.ApplySubstToFormula.P3'(B, C, E).
'Syntax.ApplySubstToFormula.P3.0'('MetaDefs.\\/''.F2'(A,B), C, 'MetaDefs.\\/''.F2'(D,E)) :-  % added 2 \ djd
        'Syntax.ApplySubstToFormula.P3'(A, C, D),
        'Syntax.ApplySubstToFormula.P3'(B, C, E).
'~Syntax.ApplySubstToFormula.P3.0'('MetaDefs.\\/''.F2'(A,B), C, 'MetaDefs.\\/''.F2'(D,E)) :-  % added 2 \ djd
        '~Syntax.ApplySubstToFormula.P3'(A, C, D),
...
'~Syntax.CheckVariantFormulas1.P4'('MetaDefs.&''.F2'(A,B), 'MetaDefs.&''.F2'(C,D), E, F) :-
        '~Syntax.CheckVariantFormulas1.P4'(A, C, E, G),
        '~Syntax.CheckVariantFormulas1.P4'(B, D, G, F).
'Syntax.CheckVariantFormulas1.P4'('MetaDefs.\\/''.F2'(A,B), 'MetaDefs.\\/''.F2'(C,D), E, F) :-  % added 2 \ djd
        'Syntax.CheckVariantFormulas1.P4'(A, C, E, G),
        'Syntax.CheckVariantFormulas1.P4'(B, D, G, F).
'~Syntax.CheckVariantFormulas1.P4'('MetaDefs.\\/''.F2'(A,B), 'MetaDefs.\\/''.F2'(C,D), E, F) :-  % added 2 \ djd
        '~Syntax.CheckVariantFormulas1.P4'(A, C, E, G),
...
'~Syntax.ConditionalFreeFormula.P1'('MetaDefs.&''.F2'(A,B)) :-
        '~Syntax.ConditionalFreeFormula.P1'(A),
        '~Syntax.ConditionalFreeFormula.P1'(B).
'Syntax.ConditionalFreeFormula.P1'('MetaDefs.\\/''.F2'(A,B)) :-  % added \ djd
        'Syntax.ConditionalFreeFormula.P1'(A),
        'Syntax.ConditionalFreeFormula.P1'(B).
'~Syntax.ConditionalFreeFormula.P1'('MetaDefs.\\/''.F2'(A,B)) :-  % added \ djd
        '~Syntax.ConditionalFreeFormula.P1'(A),
...
'~Syntax.OpaqueType.P1.0'('MetaDefs.XType.F2'(_,_)).
'Syntax.Or.P3'(A, B, 'MetaDefs.\\/''.F2'(A,B)).  % added \ djd
'~Syntax.Or.P3'(A, B, 'MetaDefs.\\/''.F2'(A,B)).  % added \ djd
...
'~Syntax.RenameAllFormula3.P6'('MetaDefs.&''.F2'(A,B), C, D, E, F, 'MetaDefs.&''.F2'(G,H)) :-
        '~Syntax.RenameAllFormula3.P6'(A, C, I, E, J, G),
        '~Syntax.RenameAllFormula3.P6'(B, I, D, J, F, H).
'Syntax.RenameAllFormula3.P6'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, 'MetaDefs.\\/''.F2'(G,H)) :-  % added 2 \ djd
        'Syntax.RenameAllFormula3.P6'(A, C, I, E, J, G),
        'Syntax.RenameAllFormula3.P6'(B, I, D, J, F, H).
'~Syntax.RenameAllFormula3.P6'('MetaDefs.\\/''.F2'(A,B), C, D, E, F, 'MetaDefs.\\/''.F2'(G,H)) :-   % added 2 \ djd
        '~Syntax.RenameAllFormula3.P6'(A, C, I, E, J, G),
...
'~Syntax.StandardiseCommits.P5'('MetaDefs.Empty.C0', A, A, B, B).
'Syntax.StandardiseCommits.P5'('MetaDefs.\\/''.F2'(_,_), A, A, B, B). % added \ djd
'~Syntax.StandardiseCommits.P5'('MetaDefs.\\/''.F2'(_,_), A, A, B, B). % added \ djd
