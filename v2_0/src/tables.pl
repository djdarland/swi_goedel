:- module(tables,[]).  % converted djd
:- style_check(-singleton). % added djd
%% :- module('Tables', []).
:- discontiguous 'Tables':'Tables.FirstNode.P3.0'/3. %% added djd
:- discontiguous 'Tables':'~Tables.FirstNode.P3.0'/3. %% added djd
:- discontiguous 'Tables':'Tables.Combine.P5'/5. %% added djd
:- discontiguous 'Tables':'~Tables.Combine.P5'/5. %% added djd
:- discontiguous 'Tables':'Tables.Adjustment.P4'/4. %% added djd
:- discontiguous 'Tables':'~Tables.Adjustment.P4'/4. %% added djd
:- discontiguous 'Tables':'Tables.Adjust.P6'/6. %% added djd
:- discontiguous 'Tables':'~Tables.Adjust.P6'/6. %% added djd
:- discontiguous 'Tables':'Tables.Amend.P7'/7. %% added djd
:- discontiguous 'Tables':'~Tables.Amend.P7'/7. %% added djd
:- discontiguous 'Tables':'Tables.BalanceTable1.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.BalanceTable1.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.BalanceTable2.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.BalanceTable2.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.DeleteKey.P5'/5. %% added djd
:- discontiguous 'Tables':'~Tables.DeleteKey.P5'/5. %% added djd
:- discontiguous 'Tables':'Tables.HeightIncreased.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.HeightIncreased.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.HeightDecreased.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.HeightDecreased.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.Insert.P5'/5.  %% added djd
:- discontiguous 'Tables':'~Tables.Insert.P5'/5. %% added djd
:- discontiguous 'Tables':'Tables.JoinAux.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.JoinAux.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.LastNode.P3.0'/3. %% added djd
:- discontiguous 'Tables':'~Tables.LastNode.P3.0'/3. %% added djd
:- discontiguous 'Tables':'Tables.Restructure.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.Restructure.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.PreviousNode.P4.0'/4. %% added djd
:- discontiguous 'Tables':'~Tables.PreviousNode.P4.0'/4. %% added djd
:- discontiguous 'Tables':'Tables.NextNode.P4.0'/4. %% added djd
:- discontiguous 'Tables':'~Tables.NextNode.P4.0'/4. %% added djd
:- discontiguous 'Tables':'Tables.ListsToTable.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.ListsToTable.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.ListsToTable1.P5'/5. %% added djd
:- discontiguous 'Tables':'~Tables.ListsToTable1.P5'/5. %% added djd
:- discontiguous 'Tables':'Tables.RemoveRightmost.P5'/5. %% added djd
:- discontiguous 'Tables':'~Tables.RemoveRightmost.P5'/5. %% added djd
:- discontiguous 'Tables':'Tables.Rebalance.P4'/4. %% added djd
:- discontiguous 'Tables':'~Tables.Rebalance.P4'/4. %% added djd
:- discontiguous 'Tables':'Tables.TableSearch.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.TableSearch.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.TableMember.P3'/3. %% added djd
:- discontiguous 'Tables':'~Tables.TableMember.P3'/3. %% added djd
:- discontiguous 'Tables':'Tables.UpdateTable.P5.0'/5. %% added djd
:- discontiguous 'Tables':'~Tables.UpdateTable.P5.0'/5. %% added djd
:- discontiguous 'Tables':'Tables.TableToLists.P5'/5. %% added djd
:- discontiguous 'Tables':'~Tables.TableToLists.P5'/5. %% added djd
:- discontiguous 'Tables.FirstNode.P3.0'/3. %% added djd
:- discontiguous '~Tables.FirstNode.P3.0'/3. %% added djd
:- discontiguous 'Tables.Combine.P5'/5. %% added djd
:- discontiguous '~Tables.Combine.P5'/5. %% added djd
:- discontiguous 'Tables.Adjustment.P4'/4. %% added djd
:- discontiguous '~Tables.Adjustment.P4'/4. %% added djd
:- discontiguous 'Tables.Adjust.P6'/6. %% added djd
:- discontiguous '~Tables.Adjust.P6'/6. %% added djd
:- discontiguous 'Tables.Amend.P7'/7. %% added djd
:- discontiguous '~Tables.Amend.P7'/7. %% added djd
:- discontiguous 'Tables.BalanceTable1.P3'/3. %% added djd
:- discontiguous '~Tables.BalanceTable1.P3'/3. %% added djd
:- discontiguous 'Tables.BalanceTable2.P3'/3. %% added djd
:- discontiguous '~Tables.BalanceTable2.P3'/3. %% added djd
:- discontiguous 'Tables.DeleteKey.P5'/5. %% added djd
:- discontiguous '~Tables.DeleteKey.P5'/5. %% added djd
:- discontiguous 'Tables.HeightIncreased.P3'/3. %% added djd
:- discontiguous '~Tables.HeightIncreased.P3'/3. %% added djd
:- discontiguous 'Tables.HeightDecreased.P3'/3. %% added djd
:- discontiguous '~Tables.HeightDecreased.P3'/3. %% added djd
:- discontiguous 'Tables.Insert.P5'/5. %% added djd
:- discontiguous '~Tables.Insert.P5'/5. %% added djd
:- discontiguous 'Tables.JoinAux.P3'/3. %% added djd
:- discontiguous '~Tables.JoinAux.P3'/3. %% added djd
:- discontiguous 'Tables.LastNode.P3.0'/3. %% added djd
:- discontiguous '~Tables.LastNode.P3.0'/3. %% added djd
:- discontiguous 'Tables.Restructure.P3'/3. %% added djd
:- discontiguous '~Tables.Restructure.P3'/3. %% added djd
:- discontiguous 'Tables.PreviousNode.P4.0'/4. %% added djd
:- discontiguous '~Tables.PreviousNode.P4.0'/4. %% added djd
:- discontiguous 'Tables.NextNode.P4.0'/4. %% added djd
:- discontiguous '~Tables.NextNode.P4.0'/4. %% added djd
:- discontiguous 'Tables.ListsToTable.P3'/3. %% added djd
:- discontiguous '~Tables.ListsToTable.P3'/3. %% added djd
:- discontiguous 'Tables.ListsToTable1.P5'/5. %% added djd
:- discontiguous '~Tables.ListsToTable1.P5'/5. %% added djd
:- discontiguous 'Tables.RemoveRightmost.P5'/5. %% added djd
:- discontiguous '~Tables.RemoveRightmost.P5'/5. %% added djd
:- discontiguous 'Tables.Rebalance.P4'/4. %% added djd
:- discontiguous '~Tables.Rebalance.P4'/4. %% added djd
:- discontiguous 'Tables.TableSearch.P3'/3. %% added djd
:- discontiguous '~Tables.TableSearch.P3'/3. %% added djd
:- discontiguous 'Tables.TableMember.P3'/3. %% added djd
:- discontiguous '~Tables.TableMember.P3'/3. %% added djd
:- discontiguous 'Tables.UpdateTable.P5.0'/5. %% added djd
:- discontiguous '~Tables.UpdateTable.P5.0'/5. %% added djd
:- discontiguous 'Tables.TableToLists.P5'/5. %% added djd
:- discontiguous '~Tables.TableToLists.P5'/5. %% added djd
