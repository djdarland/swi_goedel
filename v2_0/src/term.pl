:- module(term,[term_seq/5,pop/3,push_in_constants/3,stack_to_return/5,select_return/5]).   % converted djd
...
:- discontiguous term_aux/6. % added djd
:- discontiguous term_prime_aux/6. % added djd
