:- module(transform,[transform_body/3]).  %% converted djd
...
transform_body('MetaDefs.~''.F1'('MetaDefs.&''.F2'(Formula1, Formula2)),
               VarDict, VarNo, NewVarNo,
               'MetaDefs.\\/''.F2'(NewFormula1, NewFormula2), FreeVars  % added \ djd
              ) :-
...
transform_body('MetaDefs.\\/''.F2'(Formula1, Formula2),   % added \ djd
	       VarDict, VarNo, NewVarNo,
	       'MetaDefs.\\/''.F2'(NewFormula1, NewFormula2), FreeVars   % added \ djd
              ) :-
	transform_body(Formula1, VarDict, VarNo,
...
transform_body('MetaDefs.~''.F1'('MetaDefs.\\/''.F2'(Formula1, Formula2)),   % added \ djd
	       VarDict, VarNo, NewVarNo,
               'MetaDefs.&''.F2'(NewFormula1, NewFormula2), FreeVars
              ) :-
	transform_body('MetaDefs.~''.F1'(Formula1), VarDict, VarNo,
